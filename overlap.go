...
// Check if two spectra overlap and take the overlap data
...
// Find indices of data borders. The data is assumed to be sorted. x1 and
// x2 shall not be swapped automatically. If x1 is less then X minimum, i1
